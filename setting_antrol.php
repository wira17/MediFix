...
if (isset($_POST['simpan'])) {
    ...
    if($cons_id && $secret_key && $user_key && $base_url){
        $pdo->prepare("UPDATE setting_antrol SET cons_id=?, secret_key=?, user_key=?, base_url=?, updated_at=NOW() WHERE id=1")
...
<title>Setting Antrol BPJS - MediFix</title>
...
.page-header::before {
    ...
    right: 0;
    height: 3px;
    background: linear-gradient(90deg, var(--info), #38bdf8, #7dd3fc);
}
    ...
    <div class="container">
        ...
        <div class="page-header">
            ...
            <div class="page-subtitle">
                Konfigurasi bridging Antrean Online BPJS Kesehatan
            </div>
        </div>
            ...
            <div class="form-card">
                ...
                <form method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="base_url" value="<?= htmlspecialchars($data['base_url']) ?>" required placeholder="https://apijkn.bpjs-kesehatan.go.id">
                    </div>
