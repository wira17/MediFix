...
// Cek izin akses poliklinik
if (!isset($_SESSION['akses']['poliklinik']) || $_SESSION['akses']['poliklinik'] != 1) {
...
<title>Dashboard Poliklinik - MediFix</title>
    ...
    <div class="container">
        ...
        <div class="page-header">
            ...
            <div class="page-subtitle">
                Pusat Kontrol Pelayanan & Manajemen Poliklinik
            </div>
        ...
        <div class="menu-grid">
            ...
            <!-- Panggil Poli -->
            <a href="data_antri_poli.php" class="menu-item menu-panggil">
                <div class="menu-content">
                    ...
                    <div class="menu-text">
                        ...
                        <div class="menu-desc">Kelola antrian poli</div>
                    </div>
            ...
            <!-- Display Per Poli -->
            <a href="display_perpoli.php" target="_blank" class="menu-item menu-display-perpoli">
                <div class="menu-content">
                    <div class="menu-icon-wrapper">
                        <i class="bi bi-display"></i>
                    </div>
                    <div class="menu-text">
                        <div class="menu-title">Display Per Poli</div>
                        <div class="menu-desc">Tampilan per poliklinik</div>
                    </div>
                    <div class="menu-arrow">
                        <i class="bi bi-arrow-right"></i>
                    </div>
            ...
            <!-- Display Semua Poli -->
            <a href="display_poli.php" target="_blank" class="menu-item menu-display-semua">
                <div class="menu-content">
                    <div class="menu-icon-wrapper">
                        <i class="bi bi-collection-play"></i>
                    </div>
                    <div class="menu-text">
                        <div class="menu-title">Display Semua Poli</div>
                        <div class="menu-desc">Tampilan seluruh poli</div>
                    </div>
                    <div class="menu-arrow">
                        <i class="bi bi-arrow-right"></i>
                    </div>
