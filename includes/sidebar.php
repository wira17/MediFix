...
<aside class="main-sidebar">
  <section class="sidebar">
    ...
    <ul class="sidebar-menu" data-widget="tree">
      ...
      <li class="treeview <?= in_array($current_page, ['casemix_dashboard', 'data_casemix']) ? 'active' : '' ?>">
        <a href="#">
      ...
      <!-- BRIDGING BPJS -->
      <?php if (boleh('bridging')): ?>
      <li class="treeview <?= in_array($current_page, ['bridging_dashboard', 'bridging_vclaim', 'bridging_antrol']) ? 'active' : '' ?>">
        <a href="#">
      ...
      <!-- PENGGUNA -->
      <?php if (boleh('pengguna')): ?>
      <li class="treeview <?= in_array($current_page, ['data_pengguna', 'tambah_pengguna']) ? 'active' : '' ?>">
        <a href="#">
