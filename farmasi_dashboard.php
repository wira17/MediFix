...
// Cek izin akses farmasi
if (!isset($_SESSION['akses']['farmasi']) || $_SESSION['akses']['farmasi'] != 1) {
...
<title>Dashboard Farmasi - MediFix</title>
...
.page-header::before {
    ...
    right: 0;
    height: 4px;
    background: linear-gradient(90deg, var(--primary), var(--secondary), #fca5a5);
}
    ...
    <div class="container">
        ...
        <div class="page-header">
            ...
            <div class="page-subtitle">
                Pusat Kontrol Pelayanan Farmasi & Manajemen Obat
            </div>
        ...
        <div class="menu-grid">
            ...
            <!-- Panggil Farmasi -->
            <a href="data_antri_farmasi.php" class="menu-item menu-panggil">
                <div class="menu-content">
                    <div class="menu-icon-wrapper">
                        <i class="bi bi-capsule-pill"></i>
                    </div>
                    <div class="menu-text">
                        <div class="menu-title">Panggil Farmasi</div>
                        <div class="menu-desc">Kelola antrian resep</div>
                    </div>
            ...
            <!-- Display Farmasi -->
            <a href="display_farmasi.php" target="_blank" class="menu-item menu-display">
                <div class="menu-content">
                    <div class="menu-icon-wrapper">
                        <i class="bi bi-prescription"></i>
                    </div>
                    <div class="menu-text">
                        <div class="menu-title">Display Farmasi</div>
